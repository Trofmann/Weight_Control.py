...
class Button:
    ...
    def __init__(self, screen, center_x, center_y, text, width=400, height=50, font_size=30, button_color=(0, 200, 100),
    ...
    def draw_button(self):
        ...
        pygame.draw.rect(self.screen, self.button_frame_color, self.button_rect, 2)
